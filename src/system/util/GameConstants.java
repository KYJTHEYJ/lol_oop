...
public class GameConstants {
    ...
    public final static int URGOT_INIT_SKILL_Q_DAMAGE = 55;
    ...
    public final static int URGOT_INIT_SKILL_W_DAMAGE = 25;
    public final static int URGOT_INIT_SKILL_W_HITS = 5;
    public final static int URGOT_INIT_SKILL_E_DAMAGE = 45;
    public final static double URGOT_INIT_SKILL_E_COEFFICIENT = 1;
    public final static int URGOT_INIT_SKILL_E_HEAL_COEFFICIENT = 3;
    public final static int URGOT_INIT_SKILL_R_DAMAGE = 120;
    public final static double URGOT_INIT_SKILL_R_COEFFICIENT = 0.7;
    public final static double URGOT_INIT_SKILL_R_EXECUTE = 0.25;

    public final static String MALPHITE_NAME = "Malphite";
    ...
    public final static int MALPHITE_INIT_SKILL_E_DEFENCE_MINUS = 2;
    public final static int MALPHITE_INIT_SKILL_R_DAMAGE = 200;
    public final static double MALPHITE_INIT_SKILL_R_COEFFICIENT = 0.9;
    public final static int MALPHITE_INIT_SKILL_R_DEFENCE_MINUS = 8;

    public final static String SYNDRA_NAME = "Syndra";
    ...
    public final static int SYNDRA_INIT_SKILL_Q_DAMAGE = 90;
    ...
    public final static int SORAKA_INIT_SKILL_Q_HEAL = 40;
    public final static int SORAKA_INIT_SKILL_W_HEAL = 120;
    ...
    public final static double SORAKA_INIT_SKILL_R_COEFFICIENT = 2.5;
}
